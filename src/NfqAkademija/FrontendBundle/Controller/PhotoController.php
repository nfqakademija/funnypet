...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NfqAkademijaFrontendBundle:Photo')->findAll();
     ...
     * @Method("POST")
     * @Template("NfqAkademijaFrontendBundle:Photo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NfqAkademijaFrontendBundle:Photo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("NfqAkademijaFrontendBundle:Photo:edit.html.twig")
     */
